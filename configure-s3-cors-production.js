 ...
 * 
 * Ce script configure CORS pour le bucket de production: taha-strass-shop
 * 
 * Assurez-vous d'avoir les variables d'environnement configurées:
 * - AWS_ACCESS_KEY_ID (credentials de production)
 * - AWS_SECRET_ACCESS_KEY (credentials de production)
...
const PRODUCTION_BUCKET = "taha-strass-shop";
...
async function configureCORS() {
  try {
    ...
    console.log("🔧 Configuration CORS pour le bucket de PRODUCTION:", PRODUCTION_BUCKET);
    console.log("📍 Région:", process.env.AWS_REGION?.trim() || "us-east-1");
    ...
    console.log("\n✨ Les uploads depuis https://strass-shop.com devraient maintenant fonctionner!");
  } catch (error) {
