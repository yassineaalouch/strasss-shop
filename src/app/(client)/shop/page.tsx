...
const getAllProducts = (): Product[] => {
  return [
    ...
    },
    {
      ...
      quantity: 40,
      description:
        "Collection de tissus 100% coton, idéal s pour patchwork, quilting et projets créatifs."
    },
    {
      id: "5",
      ...
      originalPrice: 55,
      image:
        "https://static.mapetitemercerie.com/178630-large_default/machine-a-coudre-designer-jade-20-husqvarna-viking.jpg",
      rating: 4.8,
      reviews: 78,
      isNew: false,
      isOnSale: true,
      ...
      quantity: 40,
      description:
        "Ciseaux de tailleur en acier inoxydable, lames affûtées pour une coupe précise et nette."
    },
    {
      id: "6",
      ...
      price: 18,
      image:
        "https://static.mapetitemercerie.com/86898-large_default/bobine-de-fil-pour-tout-coudre-gutermann-100-m-n280.jpg",
      rating: 4.5,
      reviews: 92,
      isNew: true,
      isOnSale: false,
      ...
      quantity: 40,
      description:
        "Assortiment de boutons vintage dans différentes tailles et couleurs pour personnaliser vos créations."
    },
    {
      id: "7",
      ...
      price: 12,
      image:
        "https://static.mapetitemercerie.com/157135-large_default/super-laine-100-merinos-storm.jpg",
      rating: 4.4,
      reviews: 156,
      isNew: false,
      isOnSale: false,
      ...
      quantity: 40,
      description:
        "Épingles droites avec têtes colorées, parfaites pour le bâti et l'assemblage de tissus."
    },
    {
      id: "8",
      ...
      quantity: 40,
      description:
        "Mètre ruban de 150cm avec système rétractable automatique, idéal pour prendre les mesures."
    },
    {
      id: "9",
      ...
      quantity: 0,
      description:
        "Tissus Liberty authentiques avec motifs floraux délicats, parfaits pour vêtements et accessoires."
    },
    {
      id: "10",
      ...
      quantity: 40,
      description:
        "Dé à coudre en métal ajustable, protège efficacement le doigt lors de la couture à la main."
    },
    {
      id: "11",
      ...
      quantity: 40,
      description:
        "Surjeteuse professionnelle 4 fils pour finitions parfaites et coutures stretch."
    },
    {
      id: "12",
      ...
      price: 25,
      image:
        "https://static.mapetitemercerie.com/75645-large_default/tapis-de-decoupe.jpg",
      rating: 4.8,
      reviews: 93,
      isNew: true,
      isOnSale: false,
      ...
      quantity: 40,
      description:
        "Patron de robe vintage années 50, tailles 36 à 46, avec instructions détaillées en français."
    }
  ]
}
