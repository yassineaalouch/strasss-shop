    ...
    <section className="py-16 ">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Nous vous offrons des produits de couture de haute qualité, un service
          rapide et fiable, ainsi qu&apos;un accompagnement personnalisé pour
    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Découvrez notre gamme complète de coutureet accessoires adaptés à
            tous vos besoins
          </p>
        </div>
