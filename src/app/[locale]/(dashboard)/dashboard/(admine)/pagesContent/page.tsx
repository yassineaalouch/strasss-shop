...
//       console.log(
//         `Image marquée pour suppression lors de la sauvegarde: ${imageToRemove}`
//       )
//     }
...
//         console.log(`Suppression de ${deletedImages.length} images de S3...`)
...
//   // [Le reste de votre composant avec l'interface utilisateur]
//   if (isLoading) {
//     return (
