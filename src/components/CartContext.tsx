...
//                     {remainingForFreeShipping} MAD restants
//                   </span>
//                 </div>
//               </div>
...
//                 Ajoutez {remainingForFreeShipping} MAD pour bénéficier de la livraison gratuite !
//               </p>
//             </div>
//           )}
...
//                 ) : (
//                   <span>Frais de livraison: 30 MAD</span>
//                 )}
//               </div>
                    ...
                    <div className="flex-1">
                      ...
                      {(item.color || item.size) && (
                        <div className="text-xs text-gray-500 mb-2">
                          {item.color && (
                            <span>
                              {t("productDetails.color")} {item.color}
                            </span>
                          )}
                          {item.color && item.size && (
