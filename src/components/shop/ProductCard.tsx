          ...
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              <div className="flex items-center space-x-2 mb-2">
                <span className="text-xl font-bold text-firstColor">{product.price} DH</span>
              ...
              <div className="flex space-x-2 mb-2">
                ...
                {!product.inStock && (
                  <span className="bg-gray-500 text-white px-2 py-1 text-xs rounded">Rupture</span>
                )}
              </div>
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="p-4">
        ...
        <div className="text-xs text-gray-500 mb-3">
          <div>{product.category} • {product.material}</div>
          <div>Hauteur: {product.height} • Couleur: {product.color}</div>
        </div>
        
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-2">
            <span className="text-lg font-bold text-firstColor">{product.price} DH</span>
            {product.originalPrice && (
              <span className="text-sm text-gray-500 line-through">{product.originalPrice} DH</span>
            )}
          </div>
