...
//             className="lg:hidden self-start flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors"
//           >
...
//               className="flex-1 sm:flex-none border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 bg-white min-w-0"
//             >
...
//             <span className="text-sm text-gray-600 sm:hidden">Vue:</span>
...
const ProductSorter: React.FC<ProductSorterProps> = ({
  ...
  const sortOptions: SortOption[] = [
    ...
    { value: "rating-desc", label: t("sortOptions.ratingDesc") },
