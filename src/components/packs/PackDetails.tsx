    ...
    <div className="space-y-12">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-4">
          {/* Main Image */}
          <div className="relative aspect-square overflow-hidden rounded-2xl bg-gradient-to-br from-orange-100 to-amber-100 shadow-xl">
            ...
            {hasDiscount && (
              <div className="absolute right-4 top-4 rounded-full bg-gradient-to-r from-red-500 to-orange-500 px-4 py-2 text-sm font-bold text-white shadow-lg">
        ...
        <div className="space-y-6">
          ...
          {/* Items Count Badge */}
          <div className="inline-flex items-center gap-2 rounded-full bg-orange-100 px-4 py-2 text-orange-800">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-orange-50 to-amber-50 p-6 shadow-md border-2 border-orange-200">
            {hasDiscount && (
              <div className="mb-4 flex items-center gap-3">
                ...
                <div className="text-gray-500">
                  <p className="text-sm font-medium">Prix normal</p>
            ...
            {hasDiscount && (
              <div className="flex items-center gap-2 rounded-lg bg-green-100 px-4 py-2 text-green-800 border border-green-300">
                ...
                <span className="font-semibold">
                  Vous économisez {savings.toFixed(2)} MAD !
                </span>
              </div>
            )}
          </div>
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    showToast(
                      "Erreur lors de l'ajout du pack au panier",
                      "error"
                    )
                  }
                }}
                className="flex w-full items-center justify-center gap-3 rounded-xl bg-orange-600 px-8 py-4 text-lg font-bold text-white shadow-lg transition-all hover:bg-orange-700 hover:shadow-xl"
              >
      ...
      {pack.items && pack.items.length > 0 && (
        <div className="rounded-2xl bg-white p-8 shadow-lg">
          ...
          {/* Pack Summary */}
          <div className="mt-8 rounded-xl bg-gradient-to-r from-orange-50 to-amber-50 p-6">
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">Prix total normal</p>
...
function PackProductCard({ item, index }: { item: PackItem; index: number }) {
    ...
    return (
      <div className="flex items-center gap-4 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-4">
        ...
        <div className="flex-1">
          <p className="text-sm text-gray-500">Produit ID: {item.productId}</p>
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl border-2 border-gray-200 bg-white p-4 transition-all hover:border-orange-300 hover:shadow-lg">
      {/* Product Number Badge */}
      <div className="absolute left-2 top-2 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-orange-600 text-sm font-bold text-white shadow-md">
        {index + 1}
      </div>
      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        ...
        <Link
          ...
          className="relative h-32 w-full overflow-hidden rounded-lg bg-gradient-to-br from-orange-100 to-amber-100 sm:h-32 sm:w-32 flex-shrink-0"
        >
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2 rounded-lg bg-orange-100 px-3 py-1">
        ...
        <div className="flex items-center sm:flex-col sm:justify-center">
          <Link
            href={`/shop/${product._id}`}
            className="flex items-center gap-2 rounded-lg border-2 border-orange-600 bg-white px-4 py-2 text-sm font-medium text-orange-600 transition-all hover:bg-orange-50"
          >
            Voir détails
          </Link>
        </div>
